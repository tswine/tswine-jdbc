package cn.tswine.jdbc.common.toolkit.sequence;
...
public class IdWorker {
    ...
    public IdWorker(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public IdWorker(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
